...
@Component({
  selector: 'app-binding-select',
  templateUrl: './binding-select.component.html',
  styleUrls: ['./binding-select.component.scss'],
  providers: [
    AssignOriginalValueService
  ]
})
export class BindingSelectComponent implements OnInit {
